...
; Highlight daml_field variables as parameters
(daml_field
  (variable) @variable.parameter)

; Highlight with_field variables as parameters
(with_field
  (variable) @variable.parameter)

; Highlight signatory, observer, controller rules as keyword.declaration
(signatory) @keyword.declaration
(observer) @keyword.declaration
(controller) @keyword.declaration
